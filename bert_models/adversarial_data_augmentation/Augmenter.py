...
from textattack.augmentation.recipes import EmbeddingAugmenter, SynonymInsertionAugmenter,WordNetAugmenter
...
if __name__ == "__main__":
    ...
    output_csv = "EmbeddingAugmenter.tsv"
    augment_type =  EmbeddingAugmenter
    
#     output_csv = "SynonymInsertionAugmenter.tsv"
#     augment_type =  SynonymInsertionAugmenter
    
#     output_csv = "WordNetAugmenter.tsv"
#     augment_type =  WordNetAugmenter
    
    generate_augmented_examples(labeled_examples,output_csv, augment_type , pct_words_to_swap=0.2 , transformations_per_example = 2)

...
if __name__ == "__main__":
    ...
    generate_augmented_examples(labeled_examples,"BackTranslationAugmenter.tsv", BackTranslationAugmenter , pct_words_to_swap=0.2 , transformations_per_example = 2)
